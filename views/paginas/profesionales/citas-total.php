        ...
        <table class="tabla">
            <thead class="tabla__thead">
                <tr>
                    ...
                    <th scope="col" class="tabla__th">Paciente</th>
            ...
            <tbody class="tabla__tbody">
                <?php foreach($citas as $cita) { ?>
                    <tr class="tabla__tr">
                        ...
                        <td class="tabla__td">
                            <?php echo $cita->usuario->nombre. " ". $cita->usuario->apellido; ?>
                        </td>
                        <td class="tabla__td">
                            <?php echo $cita->motivo; ?>
                        </td>
                        <td>
                            <form method="POST" action="/profesionales/citas-total/eliminar" class="tabla__formulario">
